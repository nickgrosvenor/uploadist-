  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved album as @album" do
        ...
        post :create, {:album => { "user" => "invalid value" }}, valid_session
        assigns(:album).should be_a_new(Album)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested album" do
        ...
        Album.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => album.to_param, :album => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the album as @album" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Album.any_instance.stub(:save).and_return(false)
        put :update, {:id => album.to_param, :album => { "user" => "invalid value" }}, valid_session
        assigns(:album).should eq(album)
      end
